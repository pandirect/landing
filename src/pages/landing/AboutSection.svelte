...
<div id="about" class="about-section">
    <div class="about-info">
        <div class="about-container">
            <h2 class="title">Узнайте о нас больше</h2>
            <p class="description">
            ...
            <form>
                <div class="line">
                    <div class="field">
                        ...
                        <input type="text" name="name" class="field__input" placeholder="Ваше имя" />
                    </div>
                    <div class="field">
                        <label class="field__label">Телефон</label>
                        <input type="text" name="phone" class="field__input" placeholder="+7 (XXX) XXX-XX-XX" />
                    </div>
                </div>
    ...
    <div class="about-contacts">
        <div class="about-contacts__item" data-type="phone">+7 (902) 358-21-58</div>
        <div class="about-contacts__item" data-type="mail">info@pandirect.ru</div>
    </div>
</div>